                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="festival_bonus_title" class="form-control"
                                            value="">
                                    </div>
                                </div>
                                    ...
                                    <td>
                                        @if ($edit_permission == 'Yes')
                                            <a href="javascript:void(0)" class="btn edit"
                                                data-id="{{ $festivals_value->id }}" data-toggle="tooltip"
                                                title="" data-original-title=" Edit "> <i
                                                    class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                        @endif
                                        @if ($delete_permission == 'Yes')
                                        <a href="{{ route('delete-festivals', ['id' => $festivals_value->id]) }}" data-toggle="tooltip"
                                            title="" data-original-title="Delete"
                                            class="btn btn-danger delete-post"><i
            ...
            $('.edit').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $('#id').val(res.id);
                        $('#festival_bonus_date_month_year').val(res.festival_bonus_date_month_year);

...
@section('content')
    <section class="main-contant-section">
        ...
        <div class="mb-3">
                ...
                <div class="card-header with-border">
                    ...
                    <ol id="breadcrumb1">
                        ...
                        @if ($add_permission == 'Yes')
                            @if ($token->isEmpty())
                                <li><a href="#" type="button" data-toggle="modal" data-target="#addToken"><span
                                            class="icon icon-plus"> </span>Generate Token</a></li>
                            @endif
                        @endif
                    </ol>
            ...
            <div id="addToken" class="modal fade" role="dialog">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table>
                                        <tr>
                                            <td style="padding: 8px 15px; font-size:15px">1. Please Make sure about Real IP
                                                Address</td>
                                        </tr>
                                    </table>
                                    <div class="form-check" style="margin-top: 10px;">
                                        <input type="checkbox" class="form-check-input" id="instructionCheckbox"
                                            style="margin-top: -1.7px">
                        ...
                        <tbody>
                            @foreach ($token as $item)
                                <tr>
                                    ...
                                    <td>{{ \Str::limit($item['token'], 50) }} <a href="javascript:void(0)" class="btn btn-info show-token"
                                            data-id="{{ $item['id'] }}" data-toggle="tooltip" title=""
                                            data-original-title=" Show "> <i class="fa fa-eye"
                                                aria-hidden="true"></i> </a></td>
                                    @if ($edit_permission == 'Yes' || $add_permission == 'Yes')
                                        <td>
                    ...
                    <div class="modal-body">
                            <div class="col-md-12">
                                <div class="input-group mb-3">
                                    <textarea name="token_update" id="old_token" cols="30" rows="4" readonly></textarea>
                                </div>
    ...
    <div class="modal fade" id="edit-modal" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('token-update') }}" class="form-horizontal"
                        ...
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                <label for="name" class="col-sm-12 control-label">Device Token</label>
                                {{-- <div class="input-group-prepend">
                                    <span class="input-group-text"> <i class="fa fa-server" aria-hidden="true"></i>
                                    </span>
                                </div> --}}
                                {{-- <input type="text" name="token" id="token" class="form-control" value=""> --}}
                                <textarea name="token_update" id="token_update" cols="30" rows="4" readonly></textarea>
                            </div>
                            <p id="error-message1" style="color: red;"></p>
                        </div>
                        <div class="col-sm-offset-2 col-sm-10 mt-4">
                            <button type="submit" class="btn btn-grad" id="" data-toggle="tooltip"
                                data-original-title="Refresh"><i class="fa fa-refresh fa-lg" aria-hidden="true"></i>
                            </button>
                        </div>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        ...
        <div class="row" id="uploadSection" style="display: none;">
          <div class="col-md-8">
            <form method="post" action="{{ route('token-generate') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="password" name="password" id="password" value=""
                                                class="form-control" placeholder="admin12345">
                                        </div>
                                        <p id="error-message" style="color: red;"></p>
                                    </div>
                                    <div class="col-sm-12 mt-4">

                                        <button class="btn btn-grad" type="submit" id=""> <i
                                                class="fa fa-plus" aria-hidden="true"></i> Genarate </button>
      ...
      `;
            ...
            $('.show-token').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        // console.log(res);
                        $('#ajaxModelTitle').html("Show Device Token");
                        $('#show-modal').modal('show');
                        $('#old_token').val(res.token);
                    }
                });
            });
        });

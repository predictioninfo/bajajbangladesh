                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{route('add-employee-other-payments')}}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf

                                <input type="hidden" name="other_payment_com_id" value="{{Auth::user()->com_id}}">
                                <input type="hidden" name="other_payment_employee_id" value="{{Session::get('employee_setup_id')}}">
                                <div class="row">
            ...
            <table id="user-table" class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0)" class="btn  editModal edit" data-id="{{$other_payments_value->id}}" data-toggle="tooltip" title="Edit"  data-original-title="Edit" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                <a href="{{route('delete-employee-other-payments',['id'=>$other_payments_value->id])}}" class="btn btn-danger delete-post"data-toggle="tooltip" title="Delet"  data-original-title="Delet"> <i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            </td>
                            @endif
                        </tr>
                        @endforeach
                ...
                <div class="modal-body">
                    <form method="post" id="edit_form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label>Month-Year</label>
                                <input type="month" name="other_payment_month_year" id="other_payment_month_year" class="form-control" value="">
                            </div>
                            <div class="col-md-12 form-group">
                                <label>Title</label>
                                <input type="text" name="other_payment_title" id="other_payment_title" class="form-control" value="">
                            </div>
                            <div class="col-md-12 form-group">
                                <label>Amount</label>
                                <input type="text" name="other_payment_amount" id="other_payment_amount" class="form-control" value="">
                            </div>

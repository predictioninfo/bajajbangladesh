        ...
        try {
            $package_content_array = [
                [
                    ...
                    $request->finger_print_sub_module_two,
                    $request->finger_print_sub_module_three,
                    $request->finger_print_sub_module_four,
                    $request->finger_print_sub_module_five,
                    $request->finger_print_sub_module_six,
        ...
        try {
            $content_array = [
                [
                    ...
                    $request->finger_print_sub_module_two,
                    $request->finger_print_sub_module_device_list,
                    $request->finger_print_sub_module_re_boot,

                    $request->finger_print_sub_module_three,
                    $request->employee_without_finger_print_sub_module,

                    $request->finger_print_sub_module_four,
                    $request->employee_with_finger_print_sub_module,

                    $request->finger_print_sub_module_five,
                    $request->finger_print_sub_module_five_add,
                    $request->finger_print_sub_module_five_edit,
                    $request->finger_print_sub_module_five_delete,

                    $request->finger_print_sub_module_six,
                    $request->finger_print_sub_module_six_add,
                    $request->finger_print_sub_module_six_edit,
